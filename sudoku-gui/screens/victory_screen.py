...
class VictoryScreen(BaseScreen):
    ...
    def __init__(self, game):
        ...
        self.font_pontuation_title = game.get_font(20)
        self.font_pontuation = game.get_font(30)

        self.text_pontuation_title = self.font_pontuation_title.render(self.PONTUATION_TITLE, True, game.COLORS['PINK'])
        self.rect_pontuation_title = self.text_pontuation_title.get_rect(center=(game.WIDTH // 2, game.HEIGHT // 2 - 250))
        
        self.text_pontuation = self.font_pontuation.render(self.PONTUATION, True, game.COLORS['PINK'])
        self.rect_pontuation = self.text_pontuation.get_rect(center=(game.WIDTH // 2, game.HEIGHT // 2 - 200))
