...
TOP_LEVEL_NAME="main_communicator"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/main_communicator_rs232_0.v"       -work rs232_0 -cdslib ./cds_libs/rs232_0.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/main_communicator.v"                                                                          
fi
